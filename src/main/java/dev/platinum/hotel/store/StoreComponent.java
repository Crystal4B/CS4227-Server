...
public class StoreComponent
{
	...
	private static void createTables()
	{
		try
		{
			...
			String guestTable = (
				"CREATE TABLE IF NOT EXISTS " + GUESTS_TABLE_NAME + "(" + ID_COLUMN + " INTEGER PRIMARY KEY AUTOINCREMENT," + FIRST_NAME_COLUMN + " TEXT NOT NULL," + LAST_NAME_COLUMN + " TEXT NOT NULL," + ROOM_ID_COLUMN + " INTEGER NOT NULL," + PREVIOUS_ROOM_IDS_COLUMN + "TEXT, FOREIGN KEY(" + ROOM_ID_COLUMN + ") REFERENCES rooms(" + ID_COLUMN + "))"
			);
